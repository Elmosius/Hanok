...
<template>
  <section class="min-h-screen relative overflow-hidden py-25 lg:pt-48" id="architecture" ref="container">
    <div class="h-full w-full px-15 md:px-30 container mx-auto relative">
      ...
      <div class="h-full w-full pt-10 flex flex-col gap-y-10 text-accent md:pt-15 lg:pt-25">
        <!-- img 1 -->
        <div class="container-img-architecture lg:flex-row lg:gap-x-10">
          ...
          <div class="hidden lg:block w-1/2 h-full lg:mt-10 font-medium">
            <p class="md:text-xl lg:text-lg">Traditional Harmony</p>
            <p class="font-light mt-8 md:text-xl">Every curve and detail of Hanok is designed to live in balance with nature — the sky, the seasons, and the land.</p>
          </div>
        </div>
        ...
        <!--img 3-->
        <div class="container-img-architecture lg:flex lg:items-center lg:justify-center lg:translate-y-[45%] lg:translate-x-[12%] xl:translate-y-[46%]" ref="img3">
          <HoverArchitecture>
