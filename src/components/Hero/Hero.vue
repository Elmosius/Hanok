...
<template>
  <section class="relative h-screen lg:h-[150vh] overflow-hidden" id="home">
    <div class="w-full h-full relative">
      <div class="h-full px-15 md:px-30 container mx-auto absolute inset-0 z-10 flex flex-col gap-y-2 justify-center">
        <h1 class="text-5xl md:text-7xl lg:text-9xl text-primary font-medium">The Beauty of Hanok</h1>
